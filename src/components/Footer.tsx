      ...
      <div className="container">
        <div className="grid">
          <div>
            ...
            <p className="tag">
              Safe for families. Tough on pests. Professional condo and HOA
              pest control across Massachusetts.
            </p>
          </div>
          ...
          <div>
            <h4>Services</h4>
            <div className="links">
              <Link to="/condo-services">Condo &amp; HOA</Link>
              <Link to="/in-unit-services">In-Unit Service</Link>
        ...
        <div className="footer-bottom">
          <span>&copy; {year} BuzzKill Pest Control. All rights reserved.</span>
          <div className="legal">
